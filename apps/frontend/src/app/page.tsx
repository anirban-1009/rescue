  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <header className="row-start-1 w-full flex justify-end gap-4 items-center">
        <button className="px-4 py-2 text-sm rounded-full hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] border border-black/[.08] dark:border-white/[.145]">
          Login
        </button>
        <button className="px-4 py-2 text-sm rounded-full bg-foreground text-background hover:bg-[#383838] dark:hover:bg-[#ccc]">
          Sign Up
        </button>
      </header>
