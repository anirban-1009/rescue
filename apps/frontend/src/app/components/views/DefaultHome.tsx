    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <header className="row-start-1 w-full flex justify-end gap-4 items-center">
        <a
          ...
          className="px-4 py-2 text-sm rounded-full bg-foreground text-background hover:bg-[#383838] dark:hover:bg-[#ccc]"
        >
          Sign Up
        </a>
        <a
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center text-center max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300">
          Streamline emergency response operations with our comprehensive
          management platform
        </p>
